...
const topValueFeatures = [
  {
    number: "01",
    title: "Shared memory across every agent",
    icon: Archive,
    detail: "Decisions, outcomes, files, conversations, and prior work stay available when the next agent starts.",
    outcome: "No more re-explaining the business. Continuity becomes the default.",
  },
  {
    number: "02",
        ...
        <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr]">
          <div className="mk-reveal">
            ...
            <h2 className="mt-3 text-[42px] font-semibold leading-tight tracking-normal text-[#0f0f0e]">
              Built for small teams running real AI agent work.
            </h2>
            <p className="mt-4 text-[17px] leading-8 text-[#4a4a45]">
              Native AI small businesses need agents that remember the company, reuse what works, and stay accountable while moving fast.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[1180px] px-5 py-16 sm:px-8 lg:py-20">
          <div className="grid gap-8 lg:grid-cols-[0.78fr_1.22fr]">
            <div className="mk-reveal">
              ...
              <h2 className="mt-3 text-[42px] font-semibold leading-tight tracking-normal text-[#0f0f0e]">
                The durable layer beneath every agent workflow.
              </h2>
              <p className="mt-4 text-[17px] leading-8 text-[#4a4a45]">
                The product surface is intentionally broad because small AI-native businesses need memory, knowledge, runtime, security, evaluation, and performance to work together.
              </p>
            </div>
